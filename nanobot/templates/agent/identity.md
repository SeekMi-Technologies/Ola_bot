...
- Long-term memory: {{ memory_dir_path }}/MEMORY.md (automatically managed by Dream — do not edit directly)
- History log: {{ memory_dir_path }}/history.jsonl (append-only JSONL; prefer built-in `grep` for search).
